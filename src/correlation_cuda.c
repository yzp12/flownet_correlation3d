                       ...
                       int corr_type_multiply)
{
  ...
  int outputDepth = ceil((float)(paddedInputDepth - 2 * border_radius) / (float)stride1);
  ...
  THCudaTensor_resize5d(state, rInput1, batchSize, paddedInputDepth, paddedInputHeight, paddedInputWidth, nInputChannels);
  THCudaTensor_resize5d(state, rInput2, batchSize, paddedInputDepth, paddedInputHeight, paddedInputWidth, nInputChannels);
  THCudaTensor_resize5d(state, output, batchSize, nOutputChannels, outputDepth, outputHeight, outputwidth);
  ...
  success = Correlation_forward_cuda_kernel(  THCudaTensor_data(state, output),
                                              ...
                                              THCudaTensor_size(state, input1, 4),
                       ...
                       int corr_type_multiply)
{
  ...
  THCudaTensor_resize5d(state, rInput1, batchSize, paddedInputDepth, paddedInputHeight, paddedInputWidth, nInputChannels);
  THCudaTensor_resize5d(state, rInput2, batchSize, paddedInputDepth, paddedInputHeight, paddedInputWidth, nInputChannels);
  THCudaTensor_resize5d(state, gradInput1, batchSize, nInputChannels, depth, height, width);
  THCudaTensor_resize5d(state, gradInput2, batchSize, nInputChannels, depth, height, width);
